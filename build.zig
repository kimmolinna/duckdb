...
pub fn build(b: *std.build.Builder) !void {
    ...
    httpfs_extension.addIncludeDir("extension");
    ...
    httpfs_extension.addIncludeDir("openssl-win64/include");
...
//    defer allocator.free(result.stdout);
    ...
    duckdb_static.addIncludeDir("third_party/picohash"); 
    duckdb_static.addIncludeDir("openssl-win64/include");
    ...
    duckdb.addObjectFile("zig-out/lib/libduckdb_static.a");
    ...
    duckdb.addObjectFile("/usr/lib/x86_64-linux-gnu/libssl.so");
    duckdb.addObjectFile("/usr/lib/x86_64-linux-gnu/libcrypto.so");
...
// shell aka DuckDBClient
    ...
    shell.addIncludeDir("third_party/httplib");
    ...
    shell.addIncludeDir("third_party/picohash");
    ...
    shell.addObjectFile("/usr/lib/x86_64-linux-gnu/libssl.a");
    shell.addObjectFile("/usr/lib/x86_64-linux-gnu/libcrypto.a");
